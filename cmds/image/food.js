...
module.exports = {
	name: 'food',
	description: 'The most yum yum food on Reddit today!',
	cooldown: 4,
	category: "image",
    aliases: ["foodporn", "fp", "f", "feed", "feedme", "hungry"],
  slash: false,
  run: async(client, slash, message, args) => {
      if(message) {
        const subReddits = ["foodporn"];
...
var foodslash = new Discord.MessageEmbed()
.setImage(post.url)
.setColor('#e54918')
.setURL(`https://www.reddit.com${post.permalink}`)
.setTitle(post.title)
